...
type SocialRepository interface {
	...
	GetPendingFollowRequestsCount(ctx context.Context, userID uuid.UUID) (int, error)
	GetSentFollowRequests(ctx context.Context, userID uuid.UUID) ([]PendingRequest, error)
