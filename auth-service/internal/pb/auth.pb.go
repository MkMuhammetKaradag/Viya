...
func (x *ValidateRequest) GetUserAgent() string {
	if x != nil {
		return x.UserAgent
	}
	return ""
...
func (x *ValidateResponse) GetNewSessionId() string {
	if x != nil {
...
const file_auth_proto_rawDesc = "" +
	...
	"\n" +
	"user_agent\x18\x03 \x01(\tR\tuserAgent\"g\n" +
	"\x10ValidateResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12$\n" +
	"\x0enew_session_id\x18\x03 \x01(\tR\fnewSessionId2X\n" +
	"\vAuthService\x12I\n" +
	"\x18ValidateAndRotateSession\x12\x15.auth.ValidateRequest\x1a\x16.auth.ValidateResponseB\x1dZ\x1bgithub.com/Mk/viya-proto/pbb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.ValidateAndRotateSession:input_type -> auth.ValidateRequest
	1, // 1: auth.AuthService.ValidateAndRotateSession:output_type -> auth.ValidateResponse
